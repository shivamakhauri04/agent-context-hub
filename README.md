...
| `event-contracts` | Prediction market position limits, collateral, single-event concentration, finance correlation |
| `cash-management` | FDIC per-bank limits, idle cash threshold, SIPC cash sublimit for money market sweeps |
